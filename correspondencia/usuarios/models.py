...
class Ajustes(models.Model):
    ...
    logo_ficha_pdf = models.ImageField("Logo que se mostrará en el PDF de las fichas", help_text="*Logotipos con altura de 120px y ancho de 300px*", upload_to="logo/", blank=True, null=True)
